...
find "${PROJECTS_DIR}" -maxdepth 2 -name docker-compose.yml -print0 | xargs -0 dirname | xargs -L1 "${COMPOSE_IMAGE_UPDATER_DIR}/wrapper.sh" 2>&1 | tee "${LOG_DIR}/${DATETIME}.log"
